...
## Output of WP4
- [Snapshot 1](chapters/survey1.qmd): A comprehensive overview of the current situation of the use of AI/ML in the ESS. The Snapshot is based on the results of the survey on the use of Machine Learning within the Official Statistics with the focus on the institutional level.  
...
- [Survey 1](chapters/survey1_questionnaire.qmd) was designed to engage National Statistical Institutes (NSIs) and took place in 2025. It aimed to provide a high-level overview of how ML was being implemented and utilized within NSIs. 

- Survey 2 seeks to build a comprehensive overview of current ML projects with multiple responses per institution being expected. 
